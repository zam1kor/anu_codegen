...
/**
 * This is the item provider adapter for a {@link metamodel.LocalVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LocalVariableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LocalVariable_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LocalVariable_name_feature", "_UI_LocalVariable_type"),
				 MetamodelPackage.Literals.LOCAL_VARIABLE__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LocalVariable.class)) {
			case MetamodelPackage.LOCAL_VARIABLE__NAME:
