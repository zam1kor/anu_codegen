 ...
 * @generated
 */
public class MemberFunctionImpl extends MinimalEObjectImpl.Container implements MemberFunction {
	/**
	...
	protected EClass eStaticClass() {
		return MetamodelPackage.Literals.MEMBER_FUNCTION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.MEMBER_FUNCTION__NAME, oldName, name));
	}
	...
	public EList<LocalVariable> getLocalVariables() {
		if (localVariables == null) {
			localVariables = new EObjectContainmentEList<LocalVariable>(LocalVariable.class, this, MetamodelPackage.MEMBER_FUNCTION__LOCAL_VARIABLES);
		}
